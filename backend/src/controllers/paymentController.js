...
exports.createCheckoutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url:
        "https://envastore.online/User/checkout.html?payment=success",
      cancel_url:
        "https://envastore.online/User/checkout.html?payment=cancel"
    });
...
exports.createWalletTopupSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: "https://envastore.online/User/wallet.html?topup=success",
      cancel_url: "https://envastore.online/User/wallet.html?topup=cancel"
    });
